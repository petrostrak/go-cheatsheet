...
func runJob(id string) error {
	...
	if err != nil {
		...
		// Here we are now customizing the error with a crafted message. In this case, we
		// want to obfuscate the low-level details of whu the job isn't running because we
		// feel it's not important information to consumers of our module.
